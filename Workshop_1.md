...
1. Download the [zip file](./Workshop_1/Workshop1_files.zip) which contains an interactive code file and a sample csv file and save the contents into the MYMI_WORKSHOP_1 Folder on your computer
